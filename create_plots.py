...
uniform_plot = Plot([jax_uniform_grid, pytorch_uniform_grid, mine_uniform_grid], "Array Size", "Time (ms)")

normal_plot = Plot([jax_normal_grid, pytorch_normal_grid, mine_normal_grid], "Array Size", "Time (ms)")
...
mine_vae_with_loading_grid = Grid.load_json("results/mine_vae_with_loading.json")
...
mine_gpu_memory_usage = Grid.load_json("results/mine_gpu_memory.json")
